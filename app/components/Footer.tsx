      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 text-base">
            ...
            <a
              href="mailto:hello@unspiral.app"
              className="text-slate-400 hover:text-teal-400 transition-colors duration-300 font-medium"
            >
              hello@unspiral.app
            </a>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#"
              className="w-12 h-12 rounded-full flex items-center justify-center bg-slate-800 text-slate-400 hover:text-white hover:bg-gradient-to-br hover:from-teal-500 hover:to-cyan-500 transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg"
